...
function hostView(h, st = {}, settings = {}) {
  ...
  return {
    ...
    /* Proxmox Mail Gateway. Ein Feld je Zahl statt eines Klumpens, damit
       Tabellen und Karten dieselbe Quelle haben wie überall sonst. */
    in24: x.in24 ?? null, out24: x.out24 ?? null,
    spam: x.spam ?? null, spamAus: x.spamAus ?? null, spamAnteil: x.spamAnteil ?? null,
    virus: x.virus ?? null, virusAus: x.virusAus ?? null,
    bytesEin: x.bytesEin ?? null, bytesAus: x.bytesAus ?? null,
    greylist: x.greylist ?? null, rbl: x.rbl ?? null, pregreet: x.pregreet ?? null,
    spf: x.spf ?? null, abgewiesen: x.abgewiesen ?? null,
    bouncesEin: x.bouncesEin ?? null, bouncesAus: x.bouncesAus ?? null, junkEin: x.junkEin ?? null,
    verkehrNote: x.verkehrNote || null, statStand: x.statStand || null, stand: x.stand || null,
    queueDeferred: x.queueDeferred ?? null, queueAktiv: x.queueAktiv ?? null,
    queueHold: x.queueHold ?? null, queueAlt: x.queueAlt ?? null,
    queueNote: x.queueNote || null, queueGrenzen: x.queueGrenzen || null,
    warteschlange: x.warteschlange || null,
    quarSpam: x.quarSpam ?? null, quarSpamMb: x.quarSpamMb ?? null, quarSpamSchnitt: x.quarSpamSchnitt ?? null,
    quarVirus: x.quarVirus ?? null, quarVirusMb: x.quarVirusMb ?? null, quarNote: x.quarNote || null,
    signaturen: x.signaturen || null, signaturAlter: x.signaturAlter ?? null,
    signaturStand: x.signaturStand || null, signaturNote: x.signaturNote || null,
    dienste: x.dienste || null, diensteSteht: x.diensteSteht || null,
    diensteAuffaellig: x.diensteAuffaellig || null, diensteNote: x.diensteNote || null,
    domains: x.domains || null, viren: x.viren || null,
    insync: x.insync ?? null, pmgVersion: x.pmgVersion || null,
    diskFreiGb: x.diskFreiGb ?? null,
    /* OPNsense */
